...
export function EmptyNoCases({ onAction }: EmptyStateProps) {
  return (
    <div className="text-center py-16 px-4">
      <svg className="w-24 h-24 mx-auto mb-6" viewBox="0 0 96 96" fill="none">
  ...
  return (
    <div className="text-center py-16 px-4">
      ...
      {onAction && (
        <button
          onClick={onAction}
          className="inline-flex items-center gap-2 px-4 py-2 text-sm text-minka-600 hover:text-minka-700 hover:bg-minka-50 rounded-lg transition-colors font-medium"
        >
          Limpiar filtros
        </button>
      )}
  ...
  return (
    <div className="text-center py-16 px-4">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="inline-flex items-center gap-2 px-4 py-2 text-sm text-minka-600 hover:text-minka-700 hover:bg-minka-50 rounded-lg transition-colors font-medium border border-minka-200"
        >
